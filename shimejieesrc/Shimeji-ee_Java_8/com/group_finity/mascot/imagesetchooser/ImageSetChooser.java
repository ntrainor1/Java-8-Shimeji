...
public class ImageSetChooser extends javax.swing.JDialog
{
    ...
    public ImageSetChooser( java.awt.Frame parent, boolean modal )
    {
        ...
        for( String imageSet : children )
        {
            ...
            if( new File( "./conf/\u52D5\u4F5C.xml" ).exists( ) )
            {
                actionsFile = "conf/\u52D5\u4F5C.xml";
            }
            if( new File( "./conf/" + imageSet + "/actions.xml" ).exists( ) )
            {
                actionsFile = "conf/" + imageSet + "/actions.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u52D5\u4F5C.xml" ).exists( ) )
            {
                actionsFile = "conf/" + imageSet + "/\u52D5\u4F5C.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u00D5\u00EF\u00F2\u00F5\u00A2\u00A3.xml" ).exists( ) )
            {
                actionsFile = "conf/" + imageSet + "/\u00D5\u00EF\u00F2\u00F5\u00A2\u00A3.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u00A6-\u00BA@.xml" ).exists( ) )
            {
                actionsFile = "conf/" + imageSet + "/\u00A6-\u00BA@.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u00F4\u00AB\u00EC\u00FD.xml" ).exists( ) )
            {
                actionsFile = "conf/" + imageSet + "/\u00F4\u00AB\u00EC\u00FD.xml";
            }
            if( new File( "./conf/" + imageSet + "/one.xml" ).exists( ) )
            {
                actionsFile = "conf/" + imageSet + "/one.xml";
            }
            if( new File( "./conf/" + imageSet + "/1.xml" ).exists( ) )
            {
                actionsFile = "conf/" + imageSet + "/1.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/actions.xml" ).exists( ) )
            {
                actionsFile = "img/" + imageSet + "/conf/actions.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u52D5\u4F5C.xml" ).exists( ) )
            {
                actionsFile = "img/" + imageSet + "/conf/\u52D5\u4F5C.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u00D5\u00EF\u00F2\u00F5\u00A2\u00A3.xml" ).exists( ) )
            {
                actionsFile = "img/" + imageSet + "/conf/\u00D5\u00EF\u00F2\u00F5\u00A2\u00A3.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u00A6-\u00BA@.xml" ).exists( ) )
            {
                actionsFile = "img/" + imageSet + "/conf/\u00A6-\u00BA@.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u00F4\u00AB\u00EC\u00FD.xml" ).exists( ) )
            {
                actionsFile = "img/" + imageSet + "/conf/\u00F4\u00AB\u00EC\u00FD.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/one.xml" ).exists( ) )
            {
                actionsFile = "img/" + imageSet + "/conf/one.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/1.xml" ).exists( ) )
            {
                actionsFile = "img/" + imageSet + "/conf/1.xml";
            }

            // Determine behaviors file
            String behaviorsFile = "./conf/behaviors.xml";
            if( new File( "./conf/\u884C\u52D5.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/\u884C\u52D5.xml";
            }
            if( new File( "./conf/" + imageSet + "/behaviors.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/behaviors.xml";
            }
            if( new File( "./conf/" + imageSet + "/behavior.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/behavior.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u884C\u52D5.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/\u884C\u52D5.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u00DE\u00ED\u00EE\u00D5\u00EF\u00F2.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/\u00DE\u00ED\u00EE\u00D5\u00EF\u00F2.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u00AA\u00B5\u00A6-.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/\u00AA\u00B5\u00A6-.xml";
            }
            if( new File( "./conf/" + imageSet + "/\u00ECs\u00F4\u00AB.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/\u00ECs\u00F4\u00AB.xml";
            }
            if( new File( "./conf/" + imageSet + "/two.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/two.xml";
            }
            if( new File( "./conf/" + imageSet + "/2.xml" ).exists( ) )
            {
                behaviorsFile = "conf/" + imageSet + "/2.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/behaviors.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/behaviors.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/behavior.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/behavior.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u884C\u52D5.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/\u884C\u52D5.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u00DE\u00ED\u00EE\u00D5\u00EF\u00F2.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/\u00DE\u00ED\u00EE\u00D5\u00EF\u00F2.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u00AA\u00B5\u00A6-.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/\u00AA\u00B5\u00A6-.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/\u00ECs\u00F4\u00AB.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/\u00ECs\u00F4\u00AB.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/two.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/two.xml";
            }
            if( new File( "./img/" + imageSet + "/conf/2.xml" ).exists( ) )
            {
                behaviorsFile = "img/" + imageSet + "/conf/2.xml";
            }
